        ...
        <div className="page4">
          ...
          <div className="page4-video">
            ...
            <div className="item">
              <video
                muted
                src="/Assets/Website-homepage-Work-02_1.webm"
              ></video>
              <Image
                src="/Assets/2nd.avif"
                alt="img"
              ...
              >
                <path
                  d="M15.5448 0H5.18164V2.21382H15.5448V0Z"
                  fill="#FFFCF1"
                />
                <path
            ...
            <div className="item">
              <video
                muted
                src="/Assets/Website-homepage-Work-03_1.webm"
              ></video>
              <Image
                src="/Assets/3rd.avif"
                alt="img"
            ...
            <div className="btm-text">
              <h2>
                <div className="up">
                  <span>
                    &nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;&nbsp;Data
                    matters, yet it&apos;s emotion that drives
                  </span>
                </div>
              </h2>
              <h2>
                <div className="up">
                  <span>
                    buying decisions. We don&apos;t believe in &apos;one size
                    fits
                  </span>
                </div>
              </h2>
